...
export const GridTileImage: React.FC<Props> = ({
  ...
  return (
    <div
      className={clsx(
        'group flex h-full w-full items-center justify-center overflow-hidden rounded-[1.1rem] border bg-[#f6f0e5] transition hover:border-primary',
        {
          'border-primary bg-white': active,
