...
type Props = { item: Product; locale: ContentLocale; priority?: boolean; size: 'full' | 'half' }
  ...
  return (
    ...
    >
      <Link
        ...
        href={getLocalizedHref(locale, `/products/${item.slug}`)}
      >
        <GridTileImage
          label={{
            amount: price!,
...
> = async ({ locale = defaultLocale, products }) => {
